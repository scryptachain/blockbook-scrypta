...
import (
	...
	build "github.com/scryptachain/blockbook-scrypta/build/tools"
	"github.com/scryptachain/blockbook-scrypta/tests/rpc"
	"github.com/scryptachain/blockbook-scrypta/tests/sync"
)
